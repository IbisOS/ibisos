...
#define H2D_DATA_BASE_ADDRESS 0x1000000 // host to data Address to store
#define D2H_DATA_BASE_ADDRESS 0x1000000 // data to host Address to store

#define PORT_NUM 0

void testRead(HBA_MEM *ptr) {
	// 2018 Read sectors from offset 0~2017, 512*2018 = 1M
